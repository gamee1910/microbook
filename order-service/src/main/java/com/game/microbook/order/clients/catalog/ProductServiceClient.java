...
public class ProductServiceClient {
    ...
    @Retry(name = "catalog-service", fallbackMethod = "getProductCodeByFallback")
    ...
    Optional<Product> getProductCodeByFallback(String code, Throwable throwable) {
        log.error("get product by code: {} fallback", code);
